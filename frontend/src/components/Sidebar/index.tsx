 ...
 const navigate=useNavigate()
  ...
  const sidebarLinks = [
    ...
    },
    {
      ...
      link:'/total_net_worth'
    },
  ];
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-62.5 flex-col overflow-y-hidden bg-[#101010] duration-300 ease-linear lg:static lg:translate-x-0 ${
